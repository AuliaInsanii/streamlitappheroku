...
with dataset:
    ...
    doyou = ['feel hopeless' ,'feel angry' , 'a popping up stressful memory' , 'feel negative' , 'have changes in eating' , 'have suicidal thought' , 'have a close friend',
         'have a social media addiction' , 'over react', 'avoid people or activities', 'have material possessions', 'panic',
